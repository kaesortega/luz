...
export default function Calculo({calculoDto}){
  ...
  useEffect(() => {
    if (calculoDto) {
      setReciboNumero(calculoDto.numeroRecibo)
      setMesFacturado(calculoDto.mesFacturado)
      setAnhoFacturado(calculoDto.anhoFacturado)
      setLecturaActualReciboGeneral(calculoDto.lecturaActualReciboGeneral)
      setFechaLecturaActualReciboGeneral(calculoDto.fechaLecturaActualReciboGeneral)
      setCargoFijo(calculoDto.cargoFijo)
      setMantRepConexion(calculoDto.mantRepCon)
      setConsumoEnergiaPrecioUnitario(calculoDto.consEnerPrecUnit)
      setAlumbradoPublico(calculoDto.alumPubl)
      setInteresCompensatorio(calculoDto.inteComp)
      setNotaDebito(calculoDto.notaDebi)
      setIgv(calculoDto.igv)
      setElecRural(calculoDto.elecRura)
      setInterMora(calculoDto.inteMora)
      setFechaLecturaActualClinOdont(calculoDto.fechLectActuClinOdon)
      setLecturaActualClinOdont(calculoDto.lectActuClinOdon)
      setFechaLecturaActualClinVet(calculoDto.fechLectActuClinVete)
      setLecturaActualClinVet(calculoDto.lectActuClinVete)
      setSubTotalClinOdont(calculoDto.subtClinOdon)
      setSubTotalClinVet(calculoDto.subtClinVete)
      setSubTotalProp(calculoDto.subtProp)
      setSubTotalReciboGeneral(calculoDto.subtReciGene)
    }
  ...
  const guardar = async (e) => {
    ...
    const dto = new CalculoDto({
      numeroRecibo: reciboNumero,
      mesFacturado: mesFacturado,
      anhoFacturado: anhoFacturado,
      lecturaActualReciboGeneral: lecturaActualReciboGeneral,
      fechaLecturaActualReciboGeneral: fechaLecturaActualReciboGeneral,
      cargoFijo: cargoFijo,
      mantRepCon: mantRepConexion,
      consEnerPrecUnit: consumoEnergiaPrecioUnitario,
      alumPubl: alumbradoPublico,
      inteComp: interesCompensatorio,
      notaDebi: notaDebito,
      igv: igv,
      elecRura: electRural,
      inteMora: interMora,
      fechLectActuClinOdon: fechaLecturaActualClinOdont,
      lectActuClinOdon: lecturaActualClinOdont,
      fechLectActuClinVete: fechaLecturaActualClinVet,
      lectActuClinVete: lecturaActualClinVet,
      subtClinOdon: subTotalClinOdont,
      subtClinVete: subTotalClinVet,
      subtProp: subTotalProp,
      subtReciGene: subTotalReciboGeneral
    });
    ...
    try {
      ...
      console.log('Cálculo guardado:', data);
    } catch (error) {
